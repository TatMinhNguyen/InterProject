...
export const COLORS: Color = {
    primaryRedHex: '#FF1616',
    primaryOrangeHex: '#E67002',
    ...
    primaryBlackRGBA: '#ddd',
    secondaryBlackRGBA: '#E1E1E1',
    primarygreenHex: '#32BEA6',
    primaryyellowHex: '#FCC419',
    primaryBlueHex: '#339AF0'
};
